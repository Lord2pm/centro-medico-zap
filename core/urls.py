...
from .views import home, show_start_message, show_menu, close_session, show_about_we, custom_recommendations
...
urlpatterns = [
    ...
    path("custom-recommendations/", custom_recommendations, name="custom-recommendations"),
